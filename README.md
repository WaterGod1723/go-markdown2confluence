...
- OSX
  ...
  ```shell
  curl -LO https://github.com/justmiles/go-markdown2confluence/releases/download/vv3.4.6/go-markdown2confluence_v3.4.6_darwin_x86_64.tar.gz
...
- Windows
  ...
  Download [the latest release](https://github.com/justmiles/go-markdown2confluence/releases/download/vv3.4.6/go-markdown2confluence_v3.4.6_windows_x86_64.tar.gz) and add to your system `PATH`
